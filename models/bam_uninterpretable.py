...
class AttentionPrior(nn.Module):
    def __init__(self, args: BATModelArgs0):
        super().__init__()
...
class TransformerBlock(nn.Module):
    def __init__(self, layer_id: int, args: BATModelArgs0):
        super().__init__()
        self.n_heads = args.n_heads
        self.dim = args.dim
        self.head_dim = args.dim // args.n_heads
...
class BATransformer0(nn.Module):
    def __init__(self, params: BATModelArgs0):
        super().__init__()
        self.params = params
